...
if(isset($_SESSION['username'])) {
    ...
    * {box-sizing: border-box}
    ...
    <div class="tab">
        ...
        <button class="DoubleTranspositionPage active" onclick="window.location.href = 'DoubleTranspositionPage.php';"> <a href="DoubleTranspositionPage.php" >Double Transposition</a></button>
...
_END;
    ...
    if (isset($_POST['encryptbtn'])) {
        ...
        if( preg_match("/^\*$/", $_POST['etext']) or preg_match("/^[a-zA-Z0-9 ]+$/", $_POST['etext'])) {
            ...
            $ciper_type = "2xtransposition cipher encryption";
            ...
            if ($_FILES and $_POST['etext'] == "*") {
                ...
                //check upload file
                if(!preg_match("/^[a-zA-Z0-9 ]+$/", file_get_contents($f_name)))
                    die("<script type='text/javascript'>alert('Only space, digits and alphabets are allow for double transposition cipher encryption');</script>");
...
//!!!!!!!!!!!!!!!!!!!!!!!!! BEGIN   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            echo"<br>";
            print"</lable>";
            print"&nbsp&nbsp&nbsp&nbsp&nbsp<textarea name = 'eresult' row = '10' cols = '77' style='font-size: 15px'>";
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ...
        if( preg_match("/^\*$/", $_POST['dtext']) or preg_match("/^[a-zA-Z0-9*]+$/", $_POST['dtext'])) {
            ...
            if ($_FILES and $_POST['dtext'] == "*") {
                ...
                //check upload file
                if(!preg_match("/^[a-zA-Z0-9*]+$/", file_get_contents($f_name)))
                    die("<script type='text/javascript'>alert('Only star(*), digits and alphabets are allow for double transposition cipher decryption');</script>");
